...
function AboutSection(){
    return(
        ...
        <div data-aos="fade-up" data-aos-duration="700">
          <p>I'm passionate about bringing both the technical and visual aspects of digital products to life. I care deeply about the user experience, beautiful pixels, and writing clean accessible code that's readable by humans.</p>
          <p>I'm happiest when I'm creating, learning, exploring, and thinking about how to make things better and solve problems.</p>
          <p>Born and raised Pittsburgher who now lives in Dallas, TX.
